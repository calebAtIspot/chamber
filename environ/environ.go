...
func (e *Environ) load(ctx context.Context, s store.Store, service string, collisions *[]string, noPaths bool) error {
...
func (e *Environ) Load(ctx context.Context, s store.Store, service string, collisions *[]string) error {
	return e.load(ctx, s, service, collisions, false)
}

// LoadNoPaths is identical to Load, but uses v1-style "."-separated paths
//
// Deprecated like all noPaths functionality
func (e *Environ) LoadNoPaths(ctx context.Context, s store.Store, service string, collisions *[]string) error {
	return e.load(ctx, s, service, collisions, true)
}
...
func (e *Environ) LoadStrict(ctx context.Context, s store.Store, valueExpected string, pristine bool, services ...string) error {
	return e.loadStrict(ctx, s, valueExpected, pristine, false, services...)
}

// LoadNoPathsStrict is identical to LoadStrict, but uses v1-style "."-separated paths
//
// Deprecated like all noPaths functionality
func (e *Environ) LoadStrictNoPaths(ctx context.Context, s store.Store, valueExpected string, pristine bool, services ...string) error {
	return e.loadStrict(ctx, s, valueExpected, pristine, true, services...)
}

func (e *Environ) loadStrict(ctx context.Context, s store.Store, valueExpected string, pristine bool, noPaths bool, services ...string) error {
